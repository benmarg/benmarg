...
const Home: NextPage = () => {
  ...
  const { fadeCSS: fadeCSS1, innerFadeCSS: innerFadeCSS1 } = IntersectObserv(project1);
    ...
    <>
      ...
      <main className="snap-y snap-proximity">
        ...
        <div className="h-[300vh] flex">
          ...
          <img src="/laptop.jpg" className="h-[50vh] mt-[100vh]" alt="laptop" />
        </div>
       ...
       <div className="h-[200vh] mt-[-100vh]">
          <div ref={project2} className="h-screen w-fit flex justify-between items-start flex-col pl-12 text-2xl text-offGrey sticky top-0">
            <div className="flex flex-col items-start">
              ...
              <h3 className={`mt-32 ml-8 text-8xl -indent-1 ${fadeCSS2}`}><div className={innerFadeCSS2} >Visapply</div></h3>
